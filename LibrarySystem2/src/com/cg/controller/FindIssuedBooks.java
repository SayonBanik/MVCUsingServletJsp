...
@WebServlet("/FindIssuedBooks")
public class FindIssuedBooks extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		try 
		{ 
			List<Transaction> tRecord=lSer.FindIssuedBooks();
			...
			{
				logger.debug("List found for 'Find Issued Books' in Controller and is being sent to view");
